    ...
    return {
        ...
        "retrieval": {
            **retrieval,
            ...
            "evidence_candidates_before_filter": typed_diag.get("evidence_candidates_before_filter"),
            "evidence_candidates_after_filter": typed_diag.get("evidence_candidates_after_filter", len(fallback_sources)),
            "evidence_deduplicated_count": typed_diag.get("evidence_deduplicated_count", 0),
            "evidence_dropped_low_relevance_count": typed_diag.get("evidence_dropped_low_relevance_count", 0),
            "excluded_test_chunks_count": typed_diag.get("excluded_test_chunks_count", 0),
            "excluded_test_sources": typed_diag.get("excluded_test_sources", []),
            "retrieval_filtered_for_production": typed_diag.get("retrieval_filtered_for_production", False),
            ...
            "evidence_coverage_score": typed_diag.get("evidence_coverage_score"),
            "matched_evidence_anchors": typed_diag.get("matched_evidence_anchors", []),
            "missing_evidence_anchors": typed_diag.get("missing_evidence_anchors", []),
